...
select census_region, count (state_abbreviation) as num_states from state where census_region is not null group by census_region order by num_states desc