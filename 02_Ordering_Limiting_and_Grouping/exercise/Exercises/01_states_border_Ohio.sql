...
-- (20 rows)
select population,(city_name ||', ' || state_abbreviation) as name_and_state  from city where state_abbreviation in ('PA', 'WV', 'KY', 'IN', 'MI') order by state_abbreviation, city_name
